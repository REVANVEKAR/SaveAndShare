      ...
      <div className="hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 bg-white shadow-lg">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4 mb-8">
            ...
            <span className="ml-2 text-2xl font-bold text-gray-900">CommAid</span>
          </div>
          ...
          <div className="flex-shrink-0 flex flex-col px-4 py-4 border-t border-gray-200">
            <button
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-200"
              >
              ...
              <AnimatePresence>
                {showProfileDropdown && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute bottom-full left-0 right-0 mb-2 w-full bg-white rounded-lg shadow-lg py-1"
                  >
                    <button
                      onClick={() => {
      ...
      <div className="md:hidden bg-white shadow-sm">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Building2 className="h-8 w-8 text-blue-600" />
              <span className="ml-2 text-xl font-bold text-gray-900">CommAid</span>
            </div>
            <button
            ...
            >
              ...
              <div className="mb-6 space-y-4">
                <div>
                  ...
                  <div className="text-gray-900 bg-gray-50 rounded-xl px-4 py-3 font-medium">
                    {userData?.name}
                  </div>
                </div>
                <div>
                ...
                <form onSubmit={handlePasswordUpdate} className="space-y-4">
                  ...
                  <div className="flex space-x-3">
                    <button
                      ...
                      className="flex-1 py-3 px-4 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                    >
                      Cancel
                    </button>
                    <button
      ...
      <AnimatePresence>
        {showVerifyModal && (
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-900">NGO Verification</h2>
                <button
