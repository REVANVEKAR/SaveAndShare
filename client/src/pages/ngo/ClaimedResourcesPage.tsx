  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">Claimed Resources</h2>
        
        {resources.length === 0 ? (
          <div className="text-center py-8">
            <Package size={48} className="mx-auto text-gray-400 mb-3" />
            <p className="text-gray-500">No claimed resources yet.</p>
            <p className="text-gray-400 text-sm mt-1">Resources you claim will appear here</p>
          </div>
        ) : (
                ...
                <div className="flex flex-col sm:flex-row gap-2 mt-4">
                  ...
                  {resource.status === 'claimed' && (
                    <button
                      ...
                      className="flex items-center justify-center px-3 py-1.5 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition duration-150 ease-in-out"
                    >
                      Mark as Collected
                    </button>
                  )}
